...
st.set_page_config(
    page_title='Cloud Compute Cost Forecasting App', 
    page_icon = im, 
    layout = 'centered', 
...
st.title('Cloud Compute Cost Forecasting')

st.write("""
The Cloud Compute Cost Forecasting provides 24 hours future forecast of the cost incurred for cloud compute resources using historical data...!
""")
st.write('---')
...
# showing fig1
st.header('Cloud Compute Cost Time Series with Date')
fig = px.line(data_df, x='ds', y='y')
fig.update_yaxes(title_text = 'Cloud Compute Cost')
...
if st.sidebar.button('Prediction'):
    ...
    st.header('Cloud Compute Cost Forecast')
